/**
 * Knowledge Graph Ontology Data (Verified: 2026-02-27)
 * Fix: Syntax Error & Search Optimization
 */
const graphData = {
    "nodes": [
        // =====================
        ...
        { "id": "Logic_OS", "label": "Logic Deconstruction", "group": "Governance", "level": 1, "desc": "Zero-base 추론과 주장-증거 맵을 통해 문서의 논리적 공백과 편향을 적발하는 시스템." }, // [SEARCH_RISK] 
        ...
        // =====================
        { "id": "LLM", "label": "Large Language Model", "group": "Infrastructure", "level": 1, "desc": "Primary cognitive engine evolving toward deep iterative reasoning and self-evolution." },
        ...
        { "id": "LiteRT", "label": "LiteRT", "group": "Infrastructure", "level": 2, "desc": "임베디드 장치에서 GPU/NPU 가속을 통해 밀리초 단위 추론을 지원하는 구글의 표준 런타임." }, // [SEARCH_RISK]
        { "id": "NPU_HA", "label": "NPU Hardware Acceleration", "group": "Infrastructure", "level": 2, "desc": "Hailo-8/10H 등 전용 가속기의 성능을 소프트웨어 계층으로 직결하는 물리 제어 레이어." },
        ...
        // =====================
        { "id": "Proactive_SOP", "label": "Proactive Response SOP", "group": "Application", "level": 3, "desc": "사고 징후 감지 시 엣지에서 즉각적인 자율 실행 지침을 생성하여 사고를 예방하는 대응 체계." }, // [SEARCH_RISK]
        { "id": "Edge_Twin", "label": "Digital Twin", "group": "Application", "level": 3, "desc": "OT 데이터를 엣지에서 실시간 동기화하여 물리 장비의 상태를 최적화하는 디지털 복제 모델." },
        { "id": "Safety_Agent", "label": "Industrial Safety Agent", "group": "Application", "level": 3, "desc": "산업 현장의 비정형 데이터를 스캔하여 잠재적 위험 요소를 실시간으로 식별하고 경고하는 에이전트." },
